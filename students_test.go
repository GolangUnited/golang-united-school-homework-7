...
func TestLess(t *testing.T){
	...
	tPeopleList := []struct{
		...
		{peopleList, 0, 1, true}, //less lastname i, j 
		{peopleList, 1, 0, false}, //less lastname j, i
		{peopleList, 0, 2, false},	//less firstname j, i
		{peopleList, 2, 0, true},	//less firstname i, j
		{peopleList, 0, 3, false},	//i younger j
		{peopleList, 3, 0, true},	//j younger i
	}
...
func TestSwap(t *testing.T){
	...
	person03 := Person {"Jeyn", "Pupis", time.Date(1982,time.February,15,0,0,0,0, time.UTC)}
	person04 := Person {"Billy", "Wiliams", time.Date(1982, time.June,29,0,0,0,0, time.UTC)}
	peopleList01 := People{person01, person02, person03, person04}
	peopleList02 := People{person02, person01, person03, person04}
	peopleList03 := People{person04, person01, person03, person02}
	peopleList04 := People{person04, person02, person03, person01}
	...
	peopleList03.Swap(1, 3)
	as.EqualValues(peopleList03, peopleList04)
